...
bool Render::Awake()
{
	...
	font = TTF_OpenFont("Assets/Fonts/Silver/Silver.ttf", 100);
...
// Blit to screen
bool Render::DrawTexture(SDL_Texture* texture, SDL_RendererFlip flip, int x, int y, const SDL_Rect* section, float speed, double angle, int pivotX, int pivotY) const
{
	bool ret = true;
	int scale = Engine::GetInstance().window.get()->GetScale();
