...
public:
	...
	int blockedGid = 1025; //Gid of the tiles that block the path - Important adjust this value to your map
	int highCostGid = 1026; //Gid of the tiles that have high cost - Important adjust this value to your map
